      ...
      <div className="container-soft">
        ...
        <Reveal delay={100}>
          <div className="rounded-5xl glass shadow-soft p-4 sm:p-6 md:p-8">
            <div className="hidden md:grid grid-cols-7 gap-3 pb-4 border-b border-coral/20 font-ui text-xs uppercase tracking-widish text-coral">
              {schedule.map((s) => (
                ...
                <div
                  ...
                  className={`relative flex flex-col gap-2 rounded-4xl p-4 sm:p-5 transition-transform hover:-translate-y-1 ${
                    slot.isOff
                      ...
                      : 'bg-coral/10 text-ink-brown shadow-paper'
                  }`}
                >
                  ...
                  {i === new Date().getDay() - 1 && !slot.isOff && (
                    <span className="absolute -top-2 -right-2 inline-flex items-center gap-1 rounded-full bg-coral px-2 py-1 font-ui text-[10px] font-bold uppercase tracking-widish text-white shadow-soft">
                      <Sparkles size={10} />
                      сегодня
                    </span>
                  )}
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6 border-t border-coral/20">
              ...
              <Link
                to="/connect"
                className="font-ui text-sm font-semibold text-coral transition-opacity hover:opacity-70"
              >
